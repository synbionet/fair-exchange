...
/// Adapted from Foundry tutorial
contract SigUtils {
    /// @dev domain seperator (EIP-712) defined in the token
    ...
    /// @dev keccak256("Permit(address owner,address spender,uint256 value,uint256
